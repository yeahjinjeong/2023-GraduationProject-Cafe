...
f = open(r'/Users/jeong-yejin/practiceCRAWLING/CreateExcel/강남구.csv', 'r', encoding='CP949', newline='')
rdr = csv.reader(f)
# for code in rdr:
#     code[1]
# f.close() 
...
for code in rdr:
    url = urlopen(f'https://m.place.naver.com/restaurant/{code[1]}/review/visitor?reviewItem=0')
