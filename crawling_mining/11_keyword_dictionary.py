...
positive = {'빵집': [0], '샐러드': [0], '브런치': [0], '파스타': [0], '식사': [0], '아침식사': [0], '아점': [0], '다이어트': [0], '베이글': [0], '샌드위치': [0], '페스츄리': [0], '베이커리': [0], '신선': [0], '브레드': [0], '수프': [0], '라자냐': [0], '뇨끼': [0], '키쉬': [0], '잠봉뵈르': [0], '마르게리따': [0], '피자': [0], '요리': [0], '스테이크': [0], '밥': [0], '오므라이스': [0], '파니니 ': [0], '치킨': [0], '버거': [0], '햄버거': [0], '슈니첼': [0], '타코': [0], '토스트': [0], '프렌치토스트': [0], '핫도그': [0], 'bread': [0], 'brunch': [0], '싱싱하다': [0], '잠봉': [0], '신선하다': [0], '싱싱': [0], '음식': [0], '신선도': [0], '끼니': [0], '끼': [0], '로스터리': [1], '원두': [1], '씨앗': [1], '바리스타': [1], '핸드드립': [1], '드립커피': [1], '로스팅': [1], '커피전문점': [1], '전문적': [1], '장인': [1], '산미': [1], '볶다': [1], '라떼아트': [1], '드립백': [1], '블렌딩': [1, 2], '블랜딩': [1, 2], '블렌디드': [1, 2], '블랜디드': [1, 2], '커피맛집': [1], '#커피맛집': [1], '블렌드': [1, 2], '블랜드': [1, 2], '찻집': [2, 10], '홍차': [2], '차종류': [2], '다식': [2], '우려': [2], '애프터눈티': [2], '크림티': [2], 'tea': [2], '찻잔': [2], '티 전문': [2], '티팟': [2], '차주전자': [2], '복분자차': [2], '십전대보차': [2], '전통': [2], '오미자차': [2], '수정과': [2], '대추차': [2], '달이다': [2], '찻잎': [2], '고급티': [2], '백차': [2], '보이차': [2], '루이보스': [2], '찻자리': [2], '한방카페': [2, 10], '쌍화차': [2], '티백': [2], '블렌딩티': [2], '티세트': [2], '티 세트': [2], '차': [2], '우롱': [2], '쌍화탕': [2],
            '디저트':[3, 9], 'dessert':[3], '빵지순례':[3], '겉바':[3], '굽다':[3], '겉바속촉':[3],
            #'파이': [3], '프레첼': [3], '프레즐': [3], '고로케': [3], '바게트': [3], '바게뜨': [3], '크루아상': [3], '크로와상': [3], '겉바속쫀': [3], '뀐아망': [3], '베이비슈': [3], '소금빵': [3], '치아바타': [3], '타르트': [3], '케이크': [3], '케잌': [3], '머핀': [3], '몽블랑': [3], '깜빠뉴': [3], '깜빠': [3], '깜파뉴': [3], '테린느': [3], '휘낭':[3], '낭시': [3], '피낭': [3], '마들렌': [3], '스콘': [3], '앙버터': [3], '파니니': [3], '쌘드위치': [3], '까눌레': [3], '카눌레': [3], '구움과자': [3], '와플': [3], '젤라또': [3], '아이스크림': [3], '빙수': [3], '크로플': [3], '크렘브륄레': [3], '티라미수': [3], '머랭': [3], '머랭쿠키': [3], '마카롱': [3], '마카': [3], '꼬끄': [3], '다쿠아즈': [3], '다쿠와즈': [3], '에클레르': [3], '카스테라': [3], '푸딩': [3], '브라우니': [3], '수플레': [3], '샤벳': [3], '샤베트': [3], '크레페': [3], '시리얼': [3], '츄러스': [3], '츄로스': [3], '빵지순례': [3], '파블로바': [3], '휘': [3], '낭시': [3], '그릭': [3], '터키쉬딜라이트': [3], '까놀레': [3], '겉바': [3], '럼블': [3], '르뱅': [3], '르뱅쿠키': [3], '바나나브레드': [3], '식빵': [3], '단팥빵': [10, 3], '빵맛': [3], '붕어빵': [3], '계란빵': [3], '호밀빵': [3], '달걀빵': [3], '팥빵': [10, 3], '쌀빵': [3], '빵피': [3], '건빵': [3], '빵류': [3], '메론빵': [3], '마늘빵': [3], '버터빵': [3], '소보루빵': [3], '소보로빵': [3], '초코소라빵': [3], '제빵': [3], '빵속': [3], '에클레어': [3], '애플파이': [3], '사과차이': [3], '미트파이': [3], '초코파이': [3], '크림파이': [3], '키라임파이': [3], '슈크림': [3], '슈톨렌': [3], '크로크무슈': [3], '에그타르트': [3], '치즈케이크': [3], '컵케이크': [3], '롤케이크': [3], '팬케이크': [3], '생일케이크': [3], '버터케이크': [3], '패스츄리, 페스트리': [3], '깜바뉴': [3], '캄파뉴': [3], '말차테린느': [3], '굽다': [3], '소프트아이스크림': [3], '녹차아이스크림': [3], '팥빙수': [10, 3], '티라미슈': [3], '티라미스': [3], '브륄레': [3], '크림브륄레': [3], '브릴레': [3], '크림브릴레': [3], '카스텔라': [3], '브레드푸딩': [3], '뚱카롱': [3], 
            ...
            '케이크': [11], '독립': [11], '대여': [11], '생일파티': [11], '반입 가능': [11], '축하파티': [11], '인테리어': [11, 12, 13], '신나다': [11], '신나요': [11], '룸': [11], '파티룸': [11], 'EDM': [11], '시끌시끌': [11], '힙합': [11], '인생샷': [11, 13], '풍선': [11], '소품': [11, 13], '조명': [11, 13], '생일': [11], '생파': [11], '축하': [11], '촛불': [11], '파티': [11], '이벤트': [11], '브라이덜': [11], '베이비샤워': [11], '용품': [11], '서프라이즈': [11], '재미있다': [11], '재밌다': [11], '재미': [11], '즐겁다': [11], '화려하다': [11], '이쁘다': [11, 12, 13], '장식': [11, 13], '컨셉': [11, 13, 14], '힙한': [11, 13], '힙해': [11, 13], '힙': [11, 13], '힙하': [11, 13], '힙한곳': [11, 13], '힙플': [11, 13], '힙한데': [11, 13], '힙지로': [11, 13], '간지나다': [11], '시끌벅적하다': [11], 
...
negative = {'어둡다': [5], '어두컴컴하다': [5], '어두움': [5], '어둠': [5], '어두컴컴': [5], '시간제한': [5], '엉덩이': [5, 6, 7, 9, 10], '허리': [5, 6, 7, 9, 10], '눈치': [5], '시끌시끌': [5], '시끌벅적': [5], '바글바글': [5], '소음': [5], '협소해': [6, 7], '협소': [6, 7], '협소하': [6, 7], '협소했': [6, 7], '협소합니': [6, 7], '협소한': [6, 7], '협소했어': [6, 7], '협소함': [6, 7], '웨이팅': [7], '웨이': [7], '카공': [8, 9, 7], '공부': [8, 9, 7], '조용한': [7], '조용조': [7], '조용하다': [7], '좁다': [7], '답답하다': [7], '위험#위험하다': [9], '노키즈': [9], '더럽다': [9], '흡연': [9], '담배': [9], '지저분하다': [9], '지저분': [9], '뾰족하다': [9], '날카롭다': [9], '계단': [10], '언덕': [10], '언덕길': [10], '키오스크': [10], '특전': [11], '아이돌': [11], '웨이팅 ': [12], '핫플 ': [12], '만석': [12], '시끄럽다': [12], '불친절': [12], '불친절하다': [12], '말투': [12]}

strong_pos = {'브런치':[0], '식사':[0], '아점':[0], '끼니':[0], '아침식사':[0], '비건':[4], '채식':[4], '베지테리언':[4], '페스코':[4], '락토':[4], '오보':[4], '스트릭트':[4], '식물성':[4], '공부':[5], '작업':[5], '업무':[5], '카공':[5], '팀플':[6], '회의':[6], '스터디':[6], '단체석':[7], '대화':[8], '아이':[9], '아기':[9], '아이들':[9], '할머니':[10], '할아버지':[10], '파티':[11]}
...
f3 = open(f'/Users/jeong-yejin/2023GP_CRS/classes/classify.csv', 'w', encoding='utf-8-sig', newline='')
csvWriter = csv.writer(f3)
csvWriter.writerow(['no.', '[0]브런치/식사', '[1]커피', '[2]차', '[3]디저트', '[4]비건', '[5]공부/개인작업/업무', '[6]팀플/회의/스터디', '[7]대모임',
                   '[8]대화/수다', '[9]아이', '[10]할아버지/할머니', '[11]파티', '[12]휴식', '[13]sns/핫플', '[14]테마'])
...
#                        score[classes[7]], score[classes[8]], score[classes[9]], score[classes[10]], score[classes[11]], score[classes[12]], score[classes[13]], score[classes[14]]])
    
# f3.close()


pos_comparing(makeReview(235))
neg_comparing(makeReview(235))
final(score)
